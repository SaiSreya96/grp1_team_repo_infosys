...
export function calculateTrend(value: number): "up" | "down" | "stable" {
  // Use the provided value to bias the trend: very high values tend to keep trending 'up',
  // very low values tend to 'down', otherwise pick a semi-random trend.
  if (value >= 150) return "up";
